...
def updateIP(username="", password="", hostname="", currentIP=""):
    #setup logging
    ...
    data = {'hostname': hostname, 'myip': currentIP}
...
if __name__ == '__main__':
    updateIP(username = sys.argv[1], password = sys.argv[2], hostname = sys.argv[3], currentIP = sys.argv[4])
